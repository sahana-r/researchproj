  ...
  for i in range(min(max_boxes_to_draw, boxes.shape[0])):
    if scores is None or scores[i] > min_score_thresh:
      ...
      if scores is None:
        ...
        if image_id and not skip_labels and not skip_scores:
          ...
          if [box_height, box_width, box_xmin, box_ymin, this_label, scores[i]] not in dict_for_db[image_id]:
            dict_for_db[image_id].append([box_height, box_width, box_xmin, box_ymin, this_label, scores[i]])
